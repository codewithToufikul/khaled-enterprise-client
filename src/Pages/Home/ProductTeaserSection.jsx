...
const ProductTeaserSection = () => {
  ...
  const productCategories = [
    ...
    },
    {
      ...
      description: 'Premium seasonal vegetables and tropical fruits, carefully selected and packed to maintain freshness during international transport.',
    ...
    },
    {
      ...
      description: 'Ready-to-cook and processed food items with extended shelf life, perfect for restaurants and retail chains worldwide.',
    ...
    },
    {
      ...
      description: 'Specialty items including spices, condiments, and regional delicacies that add authentic flavors to international cuisines.',
